...
router.use("/:userId/orders", order_route_1.default);
router.use("/:userId/payments", payment_route_1.default);
router.use(authController.protect, authController.restrictTo("admin"));
router.get("/", userController.getAllUsers);
router.get("/:id", userController.getUser);
router.post("/", userController.uploadUserImage, controllers_1.setImagePath, userController.createUser);
router.patch("/:id", userController.uploadUserImage, controllers_1.setImagePath, userController.updateUser);
