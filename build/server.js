...
dotenv_1.default.config({ path: path_1.default.join(__dirname, "configs", ".env") });
var DB = process.env.DATABASE.replace("<PASSWORD>", process.env.DATABASE_PASSWORD);
var server;
mongoose_1.default.connect(DB).then(function (con) { return __awaiter(void 0, void 0, void 0, function () {
    var app, PORT;
